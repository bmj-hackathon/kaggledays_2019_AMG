...
float_cols = dfs_monthly_list[1].dtypes[dfs_monthly_list[1].dtypes == 'float64'].index.tolist()
...
categorical_cols = dfs_monthly_list[1].dtypes[dfs_monthly_list[1].dtypes == 'object'].index.tolist()
